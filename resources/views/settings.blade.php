...
<div class="modal fade" id="myModal" tabindex="-10" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form id="myForm" action="{{ route('settings.update' , $setting->id)}}" method="POST">
    ...
    <div class="mb-3">
      <label for="background" class="form-label">Gambar</label>
      <input type="text" class="form-control" id="background" name="background" value="{{ $setting->background }}" required></textarea>
    </div>
     <div class="mb-3">
      <label for="background" class="form-label">Logo</label>
      <input type="text" class="form-control" id="logo" name="logo" value="{{ $setting->logo }}" required></textarea>
    </div>
     <div class="mb-3">
      <label for="background" class="form-label">Video1</label>
      <input type="text" class="form-control" id="video1" name="video1" value="{{ $setting->video1 }}" required></textarea>
    </div>
